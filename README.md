...
- **🤖 Gemini 3.6 Flash AI Integration**:
  ...
  - **Tenga AI Assistant**: Loyalty, smart replenishment tips, and automated meal planning recommendations.
...
│   │   ├── ProfileView.tsx      # User profile, wallet, and Tenga loyalty points
│   │   └── ...
│   ├── data/
